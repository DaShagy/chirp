...
fun ChirpTextField(
    ...
    ) { textStyleModifier, interactionSource ->
        BasicTextField(
            state = state,
            enabled = enabled,
...
fun ChirpTextField_Empty_Preview() {
    ChirpTheme {
        ChirpTextField(
...
fun ChirpTextField_Filled_Preview() {
    ChirpTheme {
        ChirpTextField(
            state = rememberTextFieldState(
...
fun ChirpTextField_Disabled_Preview() {
    ChirpTheme {
        ChirpTextField(
            state = rememberTextFieldState(),
            modifier = Modifier.width(300.dp),
...
fun ChirpTextField_Error_Preview() {
    ChirpTheme {
        ChirpTextField(
            state = rememberTextFieldState(),
            modifier = Modifier.width(300.dp),
