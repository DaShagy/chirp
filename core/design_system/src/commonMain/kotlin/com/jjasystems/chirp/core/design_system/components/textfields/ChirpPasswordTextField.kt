...
import chirp.core.design_system.generated.resources.icon_eye
import chirp.core.design_system.generated.resources.icon_eye_off
...
fun ChirpPasswordTextField_Empty_Preview() {
    ChirpTheme {
...
fun ChirpPasswordTextField_Filled_Preview() {
    ChirpTheme {
        ChirpPasswordTextField(
            state = rememberTextFieldState(
...
fun ChirpPasswordTextField_Error_Preview() {
    ChirpTheme {
        ChirpPasswordTextField(
            state = rememberTextFieldState(
                initialText = "password123"
