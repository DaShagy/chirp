package com.jjasystems.chirp.core.design_system.components.buttons
...
private class ButtonStyleProvider : PreviewParameterProvider<ChirpButtonStyle> {
    override val values: Sequence<ChirpButtonStyle> = ChirpButtonStyle.values().asSequence()
}

@Composable
@Preview
private fun ChirpLightThemeButton_Preview(
...
@Composable
@Preview
private fun ChirpDarkThemeButton_Preview(
    @PreviewParameter(ButtonStyleProvider::class)
    style: ChirpButtonStyle
) {
    ChirpTheme(
